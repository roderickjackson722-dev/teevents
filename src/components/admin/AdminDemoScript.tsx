...
const sections = [
  ...
  },
  {
    ...
    points: [
      "Show the 4 tiers: Base (Free), Starter ($499), Pro ($999), Enterprise (Custom).",
      "Emphasize: \"Start free — no credit card required. Upgrade when you're ready.\"",
      "Starter highlight: \"We build your tournament platform for you — full concierge setup.\"",
      "Mention transaction fee reduction as they scale: 5% → 3% → 2% → 1%.",
    ],
  },
  {
    time: "28:00 – 30:00",
