...
// ── Demo Steps ──
const STEPS = [
  { num: 1, title: "Welcome & Quick Overview", minutes: 2, icon: MessageSquare, hero: "In just 25 minutes I'll show you how TeeVents replaces spreadsheets and lets you run a professional golf tournament in minutes.", keyMessage: "Zero upfront cost on Base plan • Flat $5 platform fee per transaction • Payments split automatically — we never hold your money", bullets: ["Introduce yourself and thank them for their time.", 'Ask: "Tell me about your tournament — how many players, is it a fundraiser, how do you manage it today?"', "Listen for pain points: spreadsheets, manual check-in, no website, payment headaches.", 'Transition: "Let me show you exactly how TeeVents solves all of that."'], route: null },
  ...
  { num: 5, title: "Registration, Payments & Fees", minutes: 5, icon: CreditCard, hero: "Flat $5 TeeVents platform fee + Stripe fee shown clearly • Default = passed to players so you keep 100% of advertised price • Toggle to absorb fees if you want.", keyMessage: "$150 registration example → Golfer pays $158.85 (fees passed) or Organizer nets $145.00 (fees absorbed).", bullets: ["Show Registration page with tiers, group sizes, and checkout breakdown.", "Walk through the fee breakdown: Base Price → $5 TeeVents Fee → Stripe Fee → Total.", '"You keep 100% of your advertised price by default."', "Show the toggle in Settings to absorb fees instead.", "Mention promo codes, group registration (up to 4 players), and waitlist."], route: "/dashboard/registration" },
...
const FLYER_TEMPLATES = [
  ...
  { id: "fees", title: "$5 flat fee per transaction", headline: "$5 flat fee per transaction", items: ["✅ No percentages", "✅ No setup fees", "✅ No hidden costs", "✅ 2.9% + $0.30 Stripe fee separate"], cta: "See pricing →" },
