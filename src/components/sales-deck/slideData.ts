...
export const slides = [
  ...
  },
  {
    ...
    plans: [
      ...
      { name: "Premium", price: "$999", fee: "0%", highlights: ["$25K hole-in-one insurance (72 golfers)", "Auction item included", "Merch store & auction management", "Surveys & priority support"] },
    ],
  },
  {
    id: "security",
