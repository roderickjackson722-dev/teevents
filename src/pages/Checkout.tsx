...
export const CHECKOUT_ITEMS: Record<string, CheckoutItem> = {
  ...
  "live-leaderboard": {
    ...
    features: ["Live public leaderboard", "Phone-based score entry", "No app download required", "Monitor display view", "Shareable public URL"],
  },
  "mobile-scoring": {
    slug: "mobile-scoring",
    title: "Live Leaderboard + Mobile Scoring",
    ...
    addonKey: "live_leaderboard",
    desc: "Combined package: real-time public leaderboard with mobile scoring from any phone — no app download required.",
    features: ["Live public leaderboard", "Phone-based score entry", "No app download required", "QR scoring codes"],
  },
  ...
  "auction-raffle": {
    ...
    features: ["Mobile bidding", "Real-time bid tracking", "Auto-draw at close"],
  },
  "custom-event-page": {
