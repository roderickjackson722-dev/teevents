...
const plans = [
  ...
  { name: "Starter", price: "$299", fee: "5%", note: "We build it for you + leaderboard & sponsors", popular: true },
  { name: "Premium", price: "$999", fee: "5%", note: "$25K hole-in-one insurance + auction" },
];
