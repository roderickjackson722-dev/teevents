...
const plans = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Get started with no cost. Run unlimited tournaments on the Base plan.",
    fee: "5% platform fee per transaction + Stripe processing fees",
    features: [
      "Unlimited tournaments on Base",
      ...
      "Stripe Connect, PayPal, or check payouts",
    ],
    cta: "Start Free",
    plan: "free",
  },
  {
    name: "Pro",
    price: "$399",
    period: "per tournament (one-time)",
    description: "Unlock every premium feature for a single tournament. Pay only when you need it.",
    fee: "5% platform fee per transaction + Stripe processing fees",
    features: [
      "Everything in Base",
      "All 6 site templates + custom colors",
  ...
  },
  {
    name: "Enterprise",
    price: "Custom",
    period: "5+ tournaments / year",
    description: "Volume pricing, dedicated success manager, and white-glove onboarding for organizations running multiple events.",
    fee: "Custom platform fee available + Stripe processing fees",
    features: [
      "Everything in Pro for every tournament",
      "Volume discount pricing",
      "Dedicated account manager",
      "White-glove onboarding & setup",
      "$25,000 hole-in-one insurance options",
      "Custom integrations & SSO available",
