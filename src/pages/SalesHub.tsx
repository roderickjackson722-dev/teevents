...
// ── Demo Steps ──
const STEPS = [
  { num: 1, title: "Welcome & Quick Overview", minutes: 2, icon: MessageSquare, hero: "In just 25 minutes I'll show you how TeeVents replaces spreadsheets and lets you run a professional golf tournament in minutes.", keyMessage: "Zero upfront cost on Base plan • $5 flat platform fee per transaction • 15% reserve for refunds/chargebacks", bullets: ["Introduce yourself and thank them for their time.", 'Ask: "Tell me about your tournament — how many players, is it a fundraiser, how do you manage it today?"', "Listen for pain points: spreadsheets, manual check-in, no website, payment headaches.", 'Transition: "Let me show you exactly how TeeVents solves all of that."'], route: null },
