...
const FeesAndHold = () => (
  <Layout>
    <SEO title="Fees & Fund Holds | TeeVents Help" description="Understand TeeVents' flat $5 platform fee and 15% protective hold that safeguards organizers from chargebacks." />
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-muted-foreground mb-4">TeeVents charges a flat $5 platform fee per transaction — the same whether it's a $50 or $500 registration. This covers payment processing, platform maintenance, and customer support.</p>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-card border border-border rounded-lg p-4">
              ...
              <div className="text-sm space-y-1 bg-muted/50 rounded p-3">
                ...
                <div className="flex justify-between text-muted-foreground"><span>Platform Fee (flat)</span><span>−$5.00</span></div>
                <div className="flex justify-between text-primary font-medium"><span>You Receive</span><span>$95.00</span></div>
              </div>
            </div>
          </div>
        </section>
