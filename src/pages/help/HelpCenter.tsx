...
import { CreditCard, DollarSign, Calendar, FileText, Settings, RotateCcw } from "lucide-react";
...
const helpPages = [
  ...
  { title: "Fees & Fund Holds", description: "Understand the 4% platform fee and 15% protective hold on registration funds.", icon: DollarSign, path: "/help/fees-and-hold" },
