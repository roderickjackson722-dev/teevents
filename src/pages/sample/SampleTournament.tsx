...
export default function SampleTournament() {
  ...
  const heroBg =
    ...
    "https://images.unsplash.com/photo-1592919505780-303950717480?w=1600";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title={`${sample.tournament_name} – Sample`}
      ...
      >
        This is a <strong>custom TeeVents mockup</strong> created for{" "}
        {sample.tournament_name} •{" "}
        <a href="https://teevents.golf" className="underline">
          Learn more about TeeVents
        </a>
      </div>

      {/* Hero */}
      <div
        data-tour="event-page"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-base">
            {sample.event_date && (
              <span className="flex items-center gap-1">
                ...
                {new Date(sample.event_date).toLocaleDateString("en-US", {
                  dateStyle: "long",
                })}
              </span>
            )}
          ...
          <div className="mt-6 inline-flex flex-col items-center gap-1 rounded-lg p-1">
            ...
            <span className="text-xs text-white/80">
              Sign up, pay, and get a confirmation email in one step
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-border bg-card px-4 py-3">
        <p className="mx-auto flex max-w-5xl items-center justify-center gap-2 text-center text-sm text-muted-foreground">
          ...
          Your logo, primary color, and accent color can all be customized by
          the organizer.
        </p>
      </div>
          ...
          <div className="mx-auto w-[220px] rounded-[2rem] border-8 border-neutral-800 bg-neutral-900 p-2 shadow-xl">
            <div className="rounded-[1.4rem] bg-white overflow-hidden">
              ...
              <div className="p-3 space-y-2">
                ...
                {(participants.slice(0, 4).length
                  ? participants.slice(0, 4)
                  : [
                      { id: "a", name: "John Smith" },
                      { id: "b", name: "Marcus Johnson" },
                    ]
                ).map((p: any, i: number) => (
                  <div
                    key={p.id}
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogTitle className="text-center text-2xl">
              Want to see the organizer side?
            </DialogTitle>
            <DialogDescription className="text-center text-base pt-1">
              We built a full mockup of the dashboard <strong>you</strong> would
              use to run {sample.tournament_name}. See exactly how easy TeeVents
              makes managing your tournament.
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col gap-2 pt-2">
            <Link
              to={`/sample/${slug}/dashboard`}
              onClick={() => setShowDashIntro(false)}
            >
              <Button
                size="lg"
                className="w-full bg-[#F5A623] text-[#1a5c38] hover:bg-[#F5A623]/90 font-bold text-base"
              >
                <LayoutDashboard className="h-5 w-5 mr-2" /> Open Organizer
                Dashboard
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview" className="space-y-4 mt-4">
            <Card>
              ...
              <CardContent className="space-y-3">
                <p>
                  {sample.description ||
                    "Join us for a great day of golf supporting a great cause."}
                </p>
                <div className="grid sm:grid-cols-3 gap-3 pt-2">
                  ...
                  <div className="border rounded-md p-3">
                    ...
                    <div className="font-semibold">
                      ${(sample.registration_fee_cents / 100).toFixed(0)}
                    </div>
                  </div>
                  <div className="border rounded-md p-3">
                    <div className="text-xs text-muted-foreground">
                    ...
                    <div className="font-semibold">
                      ${(sample.team_fee_cents / 100).toFixed(0)}
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
              {sponsors.map((s) => (
                <div key={s.id} className="border rounded-md p-4 text-center">
                  <div
                    className="h-20 rounded flex items-center justify-center text-white font-bold text-lg mb-2"
                    style={{ backgroundColor: s.logo_color || "#1a5c38" }}
                  >
                    {s.name}
                  </div>
          ...
          <TabsContent value="schedule" className="mt-4">
            <Card>
              <CardHeader>
                <CardTitle>Event Day Schedule</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex justify-between border-b pb-2">
                    ...
                    <span>Lunch & Awards</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="font-medium">3:30 PM</span>
                    <span>Silent Auction Close</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
        ...
        <Card className="mt-8 bg-[#1a5c38] text-white">
          <CardContent className="py-6 text-center">
            ...
            <p className="mb-4">
              This is a custom mockup. Let's build your real tournament site on
              TeeVents.
            </p>
            <a
              ...
              rel="noreferrer"
            >
              <Button className="bg-[#F5A623] text-[#1a5c38] hover:bg-[#F5A623]/90">
