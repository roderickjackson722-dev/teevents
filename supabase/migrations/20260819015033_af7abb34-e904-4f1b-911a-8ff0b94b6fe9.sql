ALTER TABLE public.tournaments
  ADD COLUMN IF NOT EXISTS pairings_start_format text,
  ADD COLUMN IF NOT EXISTS pairings_public boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS tee_times_email_config jsonb;
