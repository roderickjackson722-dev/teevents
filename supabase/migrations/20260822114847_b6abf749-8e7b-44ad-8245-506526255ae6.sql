  ...
  WITH upd AS (
    UPDATE public.tournaments
       SET registration_open = false,
           ...
           registration_auto_close_enabled = false
...
-- Reopen The ATL Golf Championships for late registration and clear its expired schedule
UPDATE public.tournaments
   SET registration_open = true,
       registration_auto_close_enabled = false,
       registration_close_at = NULL,
       registration_auto_closed_at = NULL
